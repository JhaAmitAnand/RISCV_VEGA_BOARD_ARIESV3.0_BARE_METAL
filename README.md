...
This just introduces the minimum requirements of Assembly, linker and some 
...
and every file, are precisely because one need not have the requirement to read
a book or article and then try to code. This is a hands on learning domain and 
only doing helps.
